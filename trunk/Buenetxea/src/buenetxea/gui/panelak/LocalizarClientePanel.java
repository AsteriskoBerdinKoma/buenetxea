...
public class LocalizarClientePanel extends JPanel {
	...
	public LocalizarClientePanel() {
		super();
		setBorder(new TitledBorder(new TitledBorder(null, "",
				TitledBorder.DEFAULT_JUSTIFICATION,
				TitledBorder.DEFAULT_POSITION, null, null),
				"Localizar Cliente", TitledBorder.DEFAULT_JUSTIFICATION,
				TitledBorder.DEFAULT_POSITION, null, null));
		...
		panel.setBorder(new TitledBorder(new TitledBorder(null, "",
				TitledBorder.DEFAULT_JUSTIFICATION,
				TitledBorder.DEFAULT_POSITION, null, null), "Búsqueda:",
				TitledBorder.DEFAULT_JUSTIFICATION,
				TitledBorder.DEFAULT_POSITION, null, null));
		...
		JPanel panel_1;
		panel_1 = new JPanel();
		panel_1.setBorder(new TitledBorder(new TitledBorder(null, "",
				TitledBorder.DEFAULT_JUSTIFICATION,
				TitledBorder.DEFAULT_POSITION, null, null),
		...
		groupLayout_2.setHorizontalGroup(groupLayout_2.createParallelGroup(
				...
				groupLayout_2.createSequentialGroup().addContainerGap(361,
						Short.MAX_VALUE).addComponent(imprimirButton)
		...
		groupLayout_2.setVerticalGroup(groupLayout_2.createParallelGroup(
				...
				.addGroup(
						groupLayout_2.createSequentialGroup().addComponent(
								scrollPane, GroupLayout.DEFAULT_SIZE, 115,
		...
		groupLayout.setVerticalGroup(groupLayout.createParallelGroup(
				...
				groupLayout.createSequentialGroup().addComponent(panel,
						...
						LayoutStyle.ComponentPlacement.RELATED)
						.addComponent(panel_1, GroupLayout.DEFAULT_SIZE, 182,
								Short.MAX_VALUE)));

			...
			groupLayout_1.createParallelGroup(GroupLayout.Alignment.LEADING)
				.addGroup(groupLayout_1.createSequentialGroup()
					...
					.addGroup(groupLayout_1.createParallelGroup(GroupLayout.Alignment.LEADING)
						...
						.addGroup(groupLayout_1.createSequentialGroup()
							.addGroup(groupLayout_1.createParallelGroup(GroupLayout.Alignment.TRAILING)
								.addComponent(comboBox, GroupLayout.Alignment.LEADING, 0, 71, Short.MAX_VALUE)
								.addComponent(textField_6, GroupLayout.Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 71, Short.MAX_VALUE))
							.addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
							.addGroup(groupLayout_1.createParallelGroup(GroupLayout.Alignment.LEADING)
							...
							.addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
							.addGroup(groupLayout_1.createParallelGroup(GroupLayout.Alignment.LEADING)
								.addComponent(textField_7, GroupLayout.DEFAULT_SIZE, 71, Short.MAX_VALUE)

...
public class DatosVisita {
	...
	public DatosVisita(String dni, String direccion, String zona,
			String nombre, String apellido1, String representante,
			int telefono, double nuevo_precio, double preciopesetas,
			String llaves, String fecha) {
		this.dni = dni;
